...
function formObject(data) {
    ...
    self.cvdPredict = ko.pureComputed(function () { //LHS Score
        if (self.computedValuesAvailable()) {
            ...
            //i = 1 - Math.pow(this.s010(), Math.exp(this.predict() - this.mnxb()));
            //console.log("Left hand side cvdPredict ppoja", i);
        }
        console.log("Left hand side cvdPredict ppoja", i);
        return NaN;
        //console.log("cvdPredict", i);
        //return i;
    }, self);
    self.optimalCvdPredict = ko.pureComputed(function () { //LHS Score
        ...
        if (self.computedValuesAvailable()) {
            //var i;
            return i = 1 - Math.pow(this.s010(), Math.exp(this.optimalPredict() - this.mnxb())); //optimalPredictCalculate            
            //console.log("Lefit hand side optimalCvdPredict", i);
        }
        console.log("Lefit hand side optimalCvdPredict", i);
        return NaN;
        console.log("optimalCvdPredict ppoja", i);
        //return i;
    }, self);
    self.TenYearRisk = ko.pureComputed(function () {
        console.log('Inside Ten Year Risk calc...')
        var i = "~%";
    ...
    self.yourLifeTimeRisk = ko.pureComputed(function () {
        ...
        console.log("yourLifeTimeRisk value is here", i);
        return `${i}%`;//i + "%";
    }, self);
