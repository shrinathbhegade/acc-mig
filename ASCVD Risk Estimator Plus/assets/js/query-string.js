...
if (!params) {
  ...
  //Edge case for _ga
  if (
    params.indexOf("_ga") == -1 ||
    (params.indexOf("_ga") > -1 && params.split("&").length > 1)
  ) {
        ...
        case "unknown":
          {
            appmodel
              .Form()
              .QuiteSmokingMonths(appmodel.FormData.quiteSmoking[0]);
          }
          break;
        case "less6":
          {
            appmodel
              .Form()
              .QuiteSmokingMonths(appmodel.FormData.quiteSmoking[1]);
          }
          break;
        case "less1.5":
          {
            appmodel
              .Form()
              .QuiteSmokingMonths(appmodel.FormData.quiteSmoking[2]);
          }
          break;
        case "less2.5":
          {
            appmodel
              .Form()
              .QuiteSmokingMonths(appmodel.FormData.quiteSmoking[3]);
          }
          break;
        case "less3.5":
          {
            appmodel
              .Form()
              .QuiteSmokingMonths(appmodel.FormData.quiteSmoking[4]);
          }
          break;
        case "less5":
          {
            appmodel
              .Form()
              .QuiteSmokingMonths(appmodel.FormData.quiteSmoking[5]);
          }
          break;
        case "more5":
          {
            appmodel
              .Form()
              .QuiteSmokingMonths(appmodel.FormData.quiteSmoking[6]);
          }
          break;
        default: {
    ...
    if (appmodel.Form().VisitType()) {
      ...
      if (
        getQueryString("basesmoker") != null &&
        appmodel.Form().Smoker() != "No"
      ) {
