              ...
              $elem
                ...
                .on("click.zf.accordion", function (e) {
                  ...
                  if ($elem.hasClass("is-active")) {
                    if (
                      _this.options.allowAllClosed ||
                      $elem.siblings().hasClass("is-active")
                    ) {
                      _this.up($tabContent);
                    }
                  } else {
        ...
        value: function toggle($target) {
          if ($target.parent().hasClass("is-active")) {
            if (
              ...
              $target.parent().siblings().hasClass("is-active")
            ) {
              this.up($target);
            } else {
              return;
              ...
              $elements.each(function (i) {
                if ($(this).is($element)) {
                  ...
                  if ($(this).is(":first-child")) {
                    ...
                    $prevElement.children("[data-submenu]:visible").length
                  ) {
    ...
    _createClass(Drilldown, [
      ...
      },
      {
        ...
        value: function _keyboardEvents() {
          ...
          this.$menuItems
            .add(this.$element.find(".js-drilldown-back > a"))
              ...
              Foundation.Keyboard.handleKey(e, "Drilldown", {
                next: function () {
                  if ($element.is(_this.$submenuAnchors)) {
                    ...
                    $element
                      .parent("li")
                      .one(Foundation.transitionend($element), function () {
                        $element
                          .parent("li")
                          .find("ul li a")
      ...
      },
      {
        ...
        value: function _getMaxDims() {
          ...
          result["min-height"] =
            max * this.$menuItems[0].getBoundingClientRect().height + "px";
          result["max-width"] =
    ...
    _createClass(Dropdown, [
      ...
      },
      {
        ...
        value: function getPositionClass() {
          ...
          var horizontalPosition = /float-(\S+)\s/.exec(
      ...
      },
      {
        ...
        value: function _setPosition() {
          ...
          var position = this.getPositionClass(),
            ...
            offset =
              param === "height" ? this.options.vOffset : this.options.hOffset;
          ...
          while (
            !Foundation.Box.ImNotTouchingYou(this.$element, false, true) &&
            this.counter
          ) {
        ...
        value: function _events() {
          ...
          this.$anchor
            ...
            .on("keydown.zf.dropdown", function (e) {
              var $target = $(this),
                visibleFocusableElements = Foundation.Keyboard.findFocusable(
                  _this.$element
                );
              ...
              Foundation.Keyboard.handleKey(e, "Dropdown", {
                tab_forward: function () {
                  if (
                    _this.$element
                      .find(":focus")
                      .is(visibleFocusableElements.eq(-1))
                  ) {
                ...
                tab_backward: function () {
                  if (
                    _this.$element
                      .find(":focus")
                      .is(visibleFocusableElements.eq(0)) ||
    ...
    _createClass(Equalizer, [
      ...
      },
      {
        ...
        value: function _checkMQ() {
          var tooSmall = !Foundation.MediaQuery.atLeast(
      ...
      },
      {
        ...
        value: function _events() {
          $(window).on(
            ...
            Foundation.util.throttle(this._reflow.bind(this), 50)
          );
        },
            ...
            var isDown = this.scrollPos < winPos,
              ...
              curVisible = this.points.filter(function (p, i) {
                return isDown
                  ...
                  : p - _this.options.barOffset - _this.options.threshold <=
                      winPos;
              });
    ...
    _createClass(OffCanvas, [
        ...
        value: function _init() {
          ...
          if (!this.options.transitionTime) {
            this.options.transitionTime =
              parseFloat(
                window.getComputedStyle($("[data-off-canvas-wrapper]")[0])
                  .transitionDuration
              ) * 1000;
          }
        },
      ...
      },
      {
        ...
        value: function _trapFocus() {
          ...
          focusable
            .off(".zf.offcanvas")
            .on("keydown.zf.offcanvas", function (e) {
          ...
          this.$element.on({
            ...
            "close.zf.trigger": function (event, $element) {
              if (
                ...
                $(event.target).parents("[data-closable]")[0] === $element
              ) {
            ...
            Foundation.Keyboard.handleKey(e, "Reveal", {
              tab_forward: function () {
                if (
                  _this.$element
                    .find(":focus")
                    .is(_this.focusableElements.eq(-1))
                ) {
                  // left modal downwards, setting focus to first element
              ...
              tab_backward: function () {
                if (
                  _this.$element
                    .find(":focus")
                    .is(_this.focusableElements.eq(0)) ||
                  _this.$element.is(":focus")
                ) {
                  // left modal upwards, setting focus to last element
        ...
        value: function _setHandlePos($hndl, location, noInvert, cb) {
          ...
          if (isDbl) {
            ...
            if (isLeftHndl) {
              ...
              dim =
                parseFloat(this.$handle2[0].style[lOrT]) - movement + handlePct;
      ...
      },
      {
        ...
        value: function _handleEvent(e, $handle, val) {
          ...
          if (!val) {
            ...
            value =
              (this.options.end - this.options.start) * offsetPct +
              this.options.start;
            ...
            if (!$handle) {
              ...
              $handle =
                firstHndlPos <= secndHndlPos ? this.$handle : this.$handle2;
            }
          } else {
    ...
    _createClass(Toggler, [
      {
        ...
        value: function _init() {
          ...
          this.$element.attr(
            "aria-expanded",
            this.$element.is(":hidden") ? false : true
          );
        },
      ...
      },
      {
        ...
        value: function show() {
          if (
            ...
            !Foundation.MediaQuery.atLeast(this.options.showOn)
          ) {
